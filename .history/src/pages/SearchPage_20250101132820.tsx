...
const SearchPage = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-4">
        {/* Table Heading */}
        <div className="grid grid-cols-5 font-bold bg-gray-100 p-4 rounded-t">
              ...
              >
                <div className="grid grid-cols-5 gap-4">
                  <div className="text-center">
                    <h4 className="font-bold">Scammer Name</h4>
                  ...
                  <div className="text-center">
                    <h4 className="font-bold">Scam Amount</h4>
                    <p>{result.scamAmount}</p>
                  </div>
                  <div className="text-center">
                    <h4 className="font-bold">Date of Scam</h4>
                    <p>{result.dateOfScam}</p>
                  </div>
                  <div className="text-center">
                    <h4 className="font-bold">Report Status</h4>
                    <p>{result.reportStatus}</p>
                  </div>
                </div>
              </div>
            ))
