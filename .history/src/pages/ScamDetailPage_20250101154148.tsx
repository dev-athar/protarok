      ...
      <div className="grid gap-6 bg-gray-50 p-4 rounded-md shadow-md">
        <div className="border rounded-md p-4 bg-white shadow-sm">
          <h2 className="text-sm font-medium text-gray-500">
            Name Used on Scammer's Profile
            <button
              className="ml-2"
        ...
        <div className="border rounded-md p-4 bg-white shadow-sm">
          <h2 className="text-sm font-medium text-gray-500">
            Bank Account Details Provided by Scammer
            <button
              className="ml-2"
        ...
        <div className="border rounded-md p-4 bg-white shadow-sm">
          <h2 className="text-sm font-medium text-gray-500">
            Contact Information of Reporting Victim
            <button
              className="ml-2"
        ...
        <div className="border rounded-md p-4 bg-white shadow-sm">
          <h2 className="text-sm font-medium text-gray-500">
            URL to Scammer's Online Profile
            <button
              className="ml-2"
