  ...
  useEffect(() => {
    const fetchScamDetails = async () => {
      ...
      try {
        ...
        console.log("Additional Evidence (parsed):", data.additionalEvidence);
        console.log(
          "Type of Additional Evidence:",
          typeof data.additionalEvidence
        );
        console.log("Additional Evidence:", data.additionalEvidence);
        console.log("array:", Array.isArray(data.additionalEvidence));
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid gap-6 bg-gray-50 p-4 rounded-md shadow-md">
        ...
        {scamDetails.additionalEvidence &&
          scamDetails.additionalEvidence.length > 0 && (
            <div className="border rounded-md p-4 bg-white shadow-sm">
              <h2 className="text-sm font-medium text-gray-500">
                Proof Images
              </h2>
              <div className="flex flex-wrap gap-4 mt-4">
                {scamDetails.additionalEvidence.map((imageUrl, index) => (
                  <img
                    key={index}
                    src={imageUrl}
                    alt={`Proof ${index + 1}`}
