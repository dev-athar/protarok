...
const SubmitScamPage = () => {
  ...
  //   const maxSizeKB = 500; // Max file size is 500KB

  //   const validFiles = validateFiles(files, maxFiles, maxSizeKB);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={handleChange}
              className="w-full p-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
              placeholder="e.g., bKash, Nagad, bank, etc."
            />
          </div>
          ...
          {/* Supporting Evidence */}
          <div
            className="mb-4 border-dashed border-2 border-gray-300 p-4 rounded-lg hover:cursor-pointer"
