...
const SearchPage = () => {
  ...
  return (
    <div className="p-4">
      ...
      <div className="mt-4">
        {/* Table Heading */}
        <div className="grid grid-cols-[1fr_1fr_1fr_1.5fr_1fr_1fr] font-bold bg-gray-100 p-4 rounded-t">
        ...
        <div className="flex flex-col gap-4 mt-2">
          {loading ? (
            ...
            searchResults.map((result, index) => (
              ...
              >
                <div className="grid grid-cols-[1fr_1fr_1fr_1.5fr_1fr_1fr] gap-4">
